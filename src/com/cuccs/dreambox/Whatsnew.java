...
public class Whatsnew extends Activity {
    ...
    public void startbutton(View v) {  
		...
		Bundle extras = getIntent().getExtras();	//intent之间传递数据
		if(extras.getString("whereFrom")!=null || extras.getString("whereFrom")!=""){
			intent.putExtra("whereFrom", extras.getString("whereFrom"));
		}
