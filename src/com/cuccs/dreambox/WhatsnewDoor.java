    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		new Handler().postDelayed(new Runnable(){
			...
			public void run(){
				...
				if(extras.getString("whereFrom").equals("ContentActivity")){
					intent = new Intent (WhatsnewDoor.this,ContentActivity.class);
				}else{
					intent = new Intent (WhatsnewDoor.this,Homepage.class);		
				}
